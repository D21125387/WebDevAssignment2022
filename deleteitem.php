                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <form class="m-auto" method="post" action="signout.php">
                                    <button type="submit" class="btn btn-danger"><i class="las la-sign-out-alt"></i> Sign
                                        Out
                                    </button>
                                </form>
                            </li>
    ...
    <!-- view items content -->
        <section id="viewitems">
            <div class="container p-5">
                <p><small><span><a href="dashboard.php"
                                   style="color: black; text-decoration: none">Dashboard</a></span><span
                                style="color: gray">/Delete Item</span></small></p>
                ...
                <?php
                include 'conn.php';
                // display all rows from products
