...
<section id="viewitems">
    <div class="container p-5">
        <p><small><span>Dashboard</span><span style="color: gray">/Edit Item</span></small></p>
        ...
        <div class="row m-5">
            <form action="dbedit.php" method="post" class="col-6 m-auto">
                <div class="row mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" id="id" name="id" value="0" readonly style="display: none">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <input type="number" class="form-control form-control-sm" id="stock" min="0" step="1" name="stock">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="price" class="col-sm-4 col-form-label col-form-label-sm">Product Price</label>
                    <div class="col">
                        <input type="number" class="form-control form-control-sm" id="price" min="0.00" step="0.01" name="price">
                    </div>
                </div>
